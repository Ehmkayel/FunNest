...
const Contact = () => {
  return (
    <main className='py-16 px-4 lg:px-[3rem] xl:px-[5rem] pt-[3rem]'>
      <section className='flex flex-col md:flex-row  gap-10 xl:gap-20 justify-between items-center container max-w-[1440px] w-full mx-auto'>
      <div className='text-gray-900 font-bold w-full lg:max-w-[40%] space-y-3 mb-3'>
        ...
        <div>
          {contact.map((item) => (
            <div key={item.id} className='space-y-2 md:space-y-4 flex gap-3 items-center'>
